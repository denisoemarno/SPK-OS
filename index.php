...
<html>
<head>
	<title>Sistem Pendukung Keputusan Pemilihan Operating Sistem (OS)</title>
...
<body>
    	...
    	<div class="container">
						<div class="nav-wrapper">
								<ul class="left" style="margin-left: -52px;">
									...
									<li><a href="daftar_hp.php">DAFTAR OS</a></li>
    ...
    <!-- Body Start -->
		...
		<div id="index-banner" class="parallax-container">
			...
			<div class="parallax"><img src="assets/image/linux.png" alt="Laptop"></div>
		</div>
		<!-- Jumbotron End -->
